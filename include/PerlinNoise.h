 ...
 *	PerlinNoise.h
 *
 *  Based on Ken Perlin's reference Java implementation.
...
double noise(double x, double y, double z)
{
	...
	int X = (int) f_x & 255,              // FIND UNIT CUBE THAT
	Y = (int) f_y & 255,                  // CONTAINS POINT.
	Z = (int) f_z & 255;
	x -= f_x;                                // FIND RELATIVE X,Y,Z
	y -= f_y;                                // OF POINT IN CUBE.
	z -= f_z;
